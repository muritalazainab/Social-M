...
const Home = () => {
  ...
  <nav className="space-x-6 flex items-center">
    ...
    {/* <Link className="text-sm" to="/about">About</Link> */}
    <Link className="text-sm" to="/contact">Contact</Link>
    <button className="px-4 py-2 bg-[#FFCC29] text-white rounded-md hover:bg-yellow-500">
      <Link to="/login">Login</Link>
    </button>
  </nav>
</div>
      </header>
      <header className="bg-white shadow-md py-8 text-txtBg">
        <div className="container mx-auto px-4 text-center text-txtBg">
          <h1 className="text-4xl font-bold text-txtBg">Grow with our all-in-one marketing platform</h1>
          <p className="mt-4 text-lg text-txtBg">Helping you scale your business with ease.</p>
          <div className="mt-6">
            <button className="bg-yellow-400 text-white py-2 px-6 rounded-full hover:bg-yellow-500">  <Link
            to="register" >Get Started</Link></button>
        
          </div>
        </div>
      </header>
      <section className=" text-txtBg p-28  bg-gray-100 rounded-tr-[100px] relative mb-10">
   <div className="flex flex-col lg:flex-row gap-8">
     <div className="lg:w-1/2 flex flex-col justify-center text-txtBg">
       <h2 className="text-lg font-semibold">We strive to make our clients happy</h2>
       <h3 className="text-4xl font-bold mb-4">So, let's be happy together</h3>
 ...
 <section className="section    bg-white text-txtBg w-full p-28  ">
         <div className="grid-txt flex">
           <div className="sec-txt w-2/4 ">
             <h1 className="text-xl font-medium ">What we do?</h1>
             <p className=" text-2xl font-medium mt-6">
      ...
      {/* Services Section */}
      <section className="py-16 p-28">
        <div className="container mx-auto px-4">
          <div className="md:flex items-center">
            <div className="md:w-1/2">
              <img src="serve.png" alt="Our Services" className="rounded-lg shadow-lg" />
            </div>
            <div className="md:w-1/2 md:ml-8 mt-8 md:mt-0">
              <h2 className="text-3xl font-bold">We offer the best services for our customers</h2>
              <p className="mt-4 text-gray-500">
                Our team of experts ensures your business gets the best marketing solutions that fit your goals.
              </p>
              <ul className="mt-6 space-y-2 text-gray-700">
                <li>✔ Customized campaigns tailored to your needs</li>
                <li>✔ Experienced and dedicated team</li>
                <li>✔ Full transparency and detailed reporting</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div className="learnmore flex p-28  mb-10  text-txtBg  	 gap-4	">
        <div className="hero-image w-2/4 ">
         <img
            src="aboutus.png"
            alt=""
      ...
      <footer className="bg-gray-900 text-gray-400 py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p>Contact us: hello@marketing.com</p>
        </div>
      </footer>
    </div>
  );
