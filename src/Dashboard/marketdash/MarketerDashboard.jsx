...
function MarketerDashboard() {
  ...
  const jobs = [
    { id: 1, description: 'Job 1', budget: 500, timeframe: '2 weeks', status: 'Accepted' },
    { id: 2, description: 'Job 2', budget: 300, timeframe: '1 week', status: 'Accepted' },
  ];
  ...
  return (
    ...
    <header className="bg-bg py-4 px-6 flex justify-between items-center shadow-md">
      <h1 className="text-3xl font-semibold">Marketer <span className='text-btn'> Dashboard </span></h1>
      <div className="flex items-center gap-4">
     
        <Link to='/task' className="bg-btn text-txtBg py-1 px-6 rounded focus:outline-none shadow-lg"> Task</Link>
        <div class="relative">
        ...
        <div className="relative mr-4">
          ...
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white border border-border rounded shadow-lg">
              <a href="#" className="block px-4 py-2 text-txtBg hover:bg-txtBg hover:text-white">
                Profile
              </a>
              <a href="#" className="block px-4 py-2 text-txtBg hover:bg-txtBg hover:text-white">
              Add funds
    ...
    <div className="grid grid-cols-1 gap-6 p-6 sm:grid-cols-2 lg:grid-cols-3">
      ...
      {selectedJob && (
        <div className="job-details p-4 bg-white rounded-lg shadow-md">
          ...
          <p><strong>Timeframe:</strong> {selectedJob.timeframe}</p>
